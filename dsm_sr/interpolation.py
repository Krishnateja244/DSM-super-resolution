...
class Interpolation:
    def __init__(self, image,num_channels, scale=1):
        ...
        self.resized_image_width = int(self.image_width * scale)
        self.resized_image_height = int(self.image_height * scale)
    ...
    def nearest_neighbour(self):
        ...
        for i in range(self.channels):
            ...
            image_channel_output = np.zeros((self.resized_image_width, self.resized_image_height))
        ...
        image_rgb_output = image_rgb[0] #cv2.merge((image_rgb[0], image_rgb[1], image_rgb[2]))
        print("Completed\n")
